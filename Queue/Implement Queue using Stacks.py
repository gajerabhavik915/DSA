...
"""
In this method, created two queue, then load all existing element of Queue 1 to Queue 2 first. Then in the empty 
Queue 1 and then loaded new element to Queue 1 and again after reload all previous element to Queue 1 from Queue 2
